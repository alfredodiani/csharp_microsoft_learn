...
foreach (string name in studentNames)
{
    ...
    int gradedExtraCreditsAssignments = 0;
    ...
    */
    ...
    currentStudentExtraCreditScore = (decimal)sumExtraCreditScores / gradedExtraCreditsAssignments;
